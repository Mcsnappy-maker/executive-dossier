          ...
          <div className="container max-w-5xl mx-auto">
            ...
            <div className="relative">
              {[
                ...
                { year: "2022", role: "Operations Manager", org: "CERT", desc: "I literally took a concept from paper and built it into the region's largest pre-employability health and wellbeing project.", bullets: ["Scaled infrastructure to support 379 participants annually.", "Contributed to £850,000+ in continuation funding."] },
                { year: "2020", role: "Service Manager", org: "Lifelink", desc: "Assumed full Service Management responsibility within a four-person Senior Management Team.", bullets: ["Stabilised delivery through an exceptionally demanding pandemic operating period.", "Strengthened safeguarding and governance reporting."] },
