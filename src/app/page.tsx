            ...
            <Reveal className="mb-32 flex lg:justify-end">
              <div className="p-10 bg-surface border border-border inline-block max-w-2xl relative shadow-sm">
                ...
                <p className="text-[0.95rem] text-muted font-light leading-relaxed">
                  I combine entrepreneurial third-sector development through <strong>Kelloch</strong> with disciplined operational leadership at <strong>Sciensus</strong>. I have structured my work carefully so that I can focus my time where it adds most value: overseeing high-standard, compliance-critical environments, while ensuring clear oversight and accountability across all delivery.
                </p>
              </div>
            </Reveal>
